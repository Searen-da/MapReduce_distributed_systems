...
def server(signals):
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sock:
        ...
        # As long as you set sock.settimeout(1), you do not need a time.sleep() 
        # in loops containing sock.accept(). 
        # With a timeout of 1 second, sock.accept() plays the role of time.sleep(1).
        sock.settimeout(1)
